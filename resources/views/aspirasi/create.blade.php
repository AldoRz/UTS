    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 sm:p-10">
                <form action="{{ route('aspirasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-500">Deskripsikan dengan jelas dan lengkap termasuk solusi yang Anda usulkan</p>
                    </div>

                    <!-- File Upload -->
                    <div class="space-y-3">
                        <label class="block text-sm font-semibold text-gray-700">Dokumen Pendukung</label>
                        <div class="mt-1 flex justify-center px-6 pt-8 pb-8 border-2 border-gray-300 border-dashed rounded-2xl bg-gray-50 hover:bg-gray-100 transition duration-200">
